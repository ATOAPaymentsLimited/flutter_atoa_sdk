...
class AppCheckWarningCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => Consumer<BankInstitutionsController>(
        builder: (_, controller, __) => AnimatedSwitcher(
          duration: const Duration(milliseconds: 400),
          transitionBuilder: (child, animation) => FadeTransition(
            opacity: animation,
            child: child,
          ),
          // child: controller.urlSchemeEmptyFromApi && controller.isAppInstalled
          //     ? _containerCard(
