...
import 'package:atoa_sdk/src/shared_widgets/info_widget.dart';
import 'package:atoa_sdk/src/theme/theme.dart';
import 'package:atoa_sdk/src/views/bank_selection_bottom_sheet/widgets/animated_search_field.dart';
import 'package:atoa_sdk/src/views/bank_selection_bottom_sheet/widgets/bank_selection_title_widget.dart';
import 'package:atoa_sdk/src/views/bank_selection_bottom_sheet/widgets/bank_tab_bar.dart';
import 'package:atoa_sdk/src/views/bank_selection_bottom_sheet/widgets/business_bank_tab_view.dart';
import 'package:atoa_sdk/src/views/bank_selection_bottom_sheet/widgets/error_widget.dart';
import 'package:atoa_sdk/src/views/bank_selection_bottom_sheet/widgets/filtred_banks_widget.dart';
import 'package:atoa_sdk/src/views/bank_selection_bottom_sheet/widgets/no_result_found_widget.dart';
import 'package:atoa_sdk/src/views/bank_selection_bottom_sheet/widgets/personal_banks_tab_view.dart';
import 'package:atoa_sdk/src/views/confirmation_bottom_sheet/widgets/payment_paid_widget.dart';
        ...
        children: [
          ...
          Builder(
            builder: (context) {
              ...
              if (isLoading ||
                  (widget.state.isLoadingFilterBanks != null &&
                      widget.state.isLoadingFilterBanks! &&
                      bankController.searchTerm.isEmpty)) {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (bankController.searchTerm.isNotEmpty) ...[
                      if (widget.state.isLoadingFilterBanks == null ||
                          widget.state.isLoadingFilterBanks != null &&
                              widget.state.isLoadingFilterBanks!)
                        const Expanded(
                          child: Center(
