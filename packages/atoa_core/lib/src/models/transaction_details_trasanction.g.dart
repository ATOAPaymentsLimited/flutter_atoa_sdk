...
_$TransactionDetailsTransactionImpl
    _$$TransactionDetailsTransactionImplFromJson(Map<String, dynamic> json) =>
        _$TransactionDetailsTransactionImpl(
          ...
          storeDetails: json['storeDetails'] == null
              ...
              : StoreDetails.fromJson(
                  json['storeDetails'] as Map<String, dynamic>),
          institutionId: json['institutionId'] as String?,
        );

Map<String, dynamic> _$$TransactionDetailsTransactionImplToJson(
        _$TransactionDetailsTransactionImpl instance) =>
    <String, dynamic>{
